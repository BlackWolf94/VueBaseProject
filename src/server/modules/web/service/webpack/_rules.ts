...
const sassLoader = (isServer: boolean = false, modules?: any) => [
    ...defaultStyleLoader(isServer, modules),
...
const stylusLoader = (isServer: boolean = false, modules?: any) => [
    ...defaultStyleLoader(isServer, modules),
    createLoader('stylus-loader', {
        sourceMap: true,
